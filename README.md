...
### 自身の経験と課題意識
私は自己炎症性疾患である「家族性地中海熱」という希少疾患を患っています。この疾患は症状の個人差が大きく、自身の体調の傾向を正確に把握し、日常生活や服薬を適切にコントロールすることが不可欠です。
しかし、2〜3ヶ月に一度の定期受診という限られた時間の中で、数ヶ月間の体調推移を医師へ正確に伝えることには限界があり、**「情報の非対称性が、最適な治療方針の決定を妨げている」**という強い問題意識を持っていました。

### 本アプリで解決したいこと
「MyHealth Log」は、単なる体調記録ツールではありません。患者が自身のデータを「論理的に管理・可視化」することで、以下の3点を目指しています。

・診察の質を最大化する： 日々の微細な変化をデータ化し、PDFレポート等で医師へ提示することで、短時間でも精度の高い診察を可能にします。
...
[サンプルレポートPDF](./public/samples/デモレポート.pdf)
